from Src.BotFramework.Vkontakte.Vk.SDK.EventSender import VkNewMsgUserEvent
from Src.BotFramework.Vkontakte.Vk.VkApiAction import VkAction
from Src.BotFramework.Vkontakte.Vk.SDK.VkAnnotationSDK import HandleMessage, Authorized, RequiredLvl
...
class UserMsgController:
    ...
    @RequiredLvl(lvl=1)
    async def handle_partial(self, event_sender: VkNewMsgUserEvent):
    ...
    @RequiredLvl(lvl=2)
    async def handle_partial_2(self, event_sender: VkNewMsgUserEvent):
        self.acting.vk_action.send_message(type_id="user_id", id=event_sender.user_id, message="2E40 OK !unban")